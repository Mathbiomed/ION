...
figure(1)
hold off
f1 = plot(G2, '.r', 'MarkerSize', 16, 'NodeFontSize', 14, 'NodeFontWeight', 'bold', 'LineWidth', 1)
hold on
f2 = plot(G1, '.b', 'XData', f1.XData, 'YData', f1.YData, 'MarkerSize', 16, 'NodeFontSize', 14, 'NodeFontWeight', 'bold', 'LineWidth', 1, 'NodeLabel', {})
hold off
